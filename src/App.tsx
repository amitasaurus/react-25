...
const paths = [
  ...
  { url: '/tabs', displayName: 'Tabs' },
  { url: '/modal', displayName: 'Modal' },
  { url: '/github-profile-finder', displayName: 'Github Profile Finder' },
  { url: '/autocomplete', displayName: 'Autocomplete' },
];
...
function App() {
  ...
  return (
    <div className="relative flex items-center justify-center w-screen h-screen overflow-x-hidden overflow-y-scroll bg-white varela-round-regular dark:bg-slate-800">
      <div className="fixed top-0 right-0 flex items-center m-4">
